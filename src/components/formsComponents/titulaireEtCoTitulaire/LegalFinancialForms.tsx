            ...
            <Controller
              ...
              render={({ field }) => (
                <DropDownList
                  ...
                  {...register("capacite_juridique", {
                    required: "La capacité juridique est obligatoire",
                  })}
                />
              )}
            />
            ...
            <Controller
              ...
              render={({ field }) => (
                <DropDownList
                  ...
                  value={field.value}
                  onValueChange={field.onChange}
                  {...register("categori_socio_professionnelle", {
                    required: "La catégorie professionelle est obligatoire",
                  })}
                />
              )}
            />
              ...
              render={({ field }) => (
                <DropDownList
                  ...
                  {...register("secteur_activite_eco", {
                    required: "Le secteur économique est obligatoire",
                  })}
                />
              )}
            />
            ...
            <Controller
              ...
              render={({ field }) => (
                <DropDownList
                  ...
                  value={field.value}
                  onValueChange={field.onChange}
                  {...register("activite_risque", {
                    required: "L'activité à risque est obligatoire",
                  })}
                />
              )}
            />
            ...
            <Controller
              ...
              render={({ field }) => (
                <DropDownList
                  ...
                  value={field.value}
                  onValueChange={field.onChange}
                  {...register("pays_activite", {
                    required: "Le pays d'activité est obligatoire",
                  })}
                />
              )}
            />
